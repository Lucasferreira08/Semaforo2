...
void desenhar_vermelho(ssd1306_t *ssd) 
{
  ssd1306_fill(ssd, false);

  ssd1306_draw_string(ssd, "Vermelho", 5, 25);

  ssd1306_draw_string(ssd, "Espere!", 5, 35);

  ssd1306_send_data(ssd);
}

void desenhar_verde(ssd1306_t *ssd)
{
  ssd1306_fill(ssd, false);

  ssd1306_draw_string(ssd, "Verde", 5, 25);

  ssd1306_draw_string(ssd, "Siga em frente!", 5, 35);

  ssd1306_send_data(ssd);
}

void desenhar_amarelo(ssd1306_t *ssd)
{
  ssd1306_fill(ssd, false);

  ssd1306_draw_string(ssd, "Amarelo", 5, 25);

  ssd1306_draw_string(ssd, "Atencao!", 5, 35);
